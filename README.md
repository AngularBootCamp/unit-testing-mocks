# Angular Boot Camp example: unit-testing-mocks
...
**[StackBlitz for unit-testing-mocks](https://stackblitz.io/github/AngularBootCamp/unit-testing-mocks)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/unit-testing-mocks.git
cd unit-testing-mocks
npm install
npm start
```
